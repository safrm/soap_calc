...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.8c 2006-11-16 14:24:57 GMT")
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__pow), type);
...
{
	soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__powResponse), type);
	if (a->result)
